...
const frases = [
  ...
  { texto: "Respira profundo.", versiculo: "Isaías 26:3 – “Tú guardarás en completa paz a aquel cuyo pensamiento en ti persevera...”" },
  { texto: "Nada más importa por un momento.", versiculo: "Juan 14:27 – “La paz os dejo, mi paz os doy...”" },
  { texto: "No tienes que resolverlo todo ya.", versiculo: "Mateo 11:28 – “Venid a mí todos los que estáis trabajados y cargados...”" },
...
function takePhoto() {
  ...
  setTimeout(() => {
    document.getElementById("polaroidContainer").classList.add("fade-out");
  }, 5200);
...
function showFrase() {
  ...
  setTimeout(() => {
    fraseElem.classList.add("fade-out");
  }, 4000);
